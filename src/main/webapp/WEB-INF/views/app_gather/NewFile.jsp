					            ...
					            <div class="tab-content">
						            ...
						            <div class="row">
								        ...
								        <div class="portlet-title tabbable-line">
									    	<div class="caption">
									        	<i class="icon-globe font-red"></i>
									            <span class="caption-subject font-red bold uppercase">实时交件汇总排名</span>
									        </div>
									        <div class="actions">
	                                        <div class="btn-group">
									        ...
									        <div class="portlet-body form">
								            <div class="row">
										    	<div class="col-md-6" id="portlet_tab_bar_4_2_5_1" style="height:600px">
										        </div>
										        <div class="col-md-6" id="portlet_tab_bar_4_2_5_2" style="height:600px">
										        </div>
									        </div>
									        <div class="row">
									        <div class="col-md-6">
								        ...
								        <div class="portlet-title tabbable-line">
									    	<div class="caption">
									        	<i class="icon-globe font-red"></i>
									            <span class="caption-subject font-red bold uppercase">成功率排名</span>
									        </div>
									        <div class="actions">
	                                        <div class="btn-group">
	                                            <a href="" class="btn dark btn-outline btn-circle btn-sm dropdown-toggle" data-hover="dropdown" data-close-others="true"> 业务
									        ...
									        <div class="portlet-body form">
									            <div class="tab-content">
									            	<div class="tab2 tab-pane active" id="portlet_tab_4_2_6" style="height:900px">
								            <div class="row">
										    	<div class="col-md-12" id="portlet_tab_bar_4_2_6_1" style="height:600px">
										        </div>
									        </div>
									        <div class="row">
									        <div class="col-md-12">
						            ...
						            <div class="tab2 tab-pane" id="portlet_tab_4_2" style="height:1100px">
						            	<!--名单使用情况开始-->
								            <div class="row">
										    	<div class="col-md-6" id="portlet_tab_bar_4_2_1" style="height:600px">
										        </div>
										        <div class="col-md-6" id="portlet_tab_bar_4_2_2" style="height:600px">
										        </div>
									        </div>
									        <div class="row">
									        <div class="col-md-6">
						            ...
						            <div class="tab2 tab-pane" id="portlet_tab_4_3" style="height:1300px">
						            	<div class="row">
							            	<div class="col-md-6" id="portlet_tab_bar_4_3_1" style="height:600px">
							            	</div>
							            	<div class="col-md-6" id="portlet_tab_bar_4_3_2" style="height:600px">
							            	</div>
						            	</div>
						            	<div class="row">
						            		<div class="portlet box blue col-sm-6">
						                    	<div class="portlet-title">
						                        	<div class="caption">
						                            	<i class="fa fa-gift"></i>名单使用情况列表
						                           	</div>
						            ...
						            <div class="tab2 tab-pane" id="portlet_tab_4_4" style="height:1300px">
						            	<div class="row">
							            	<div class="col-md-6" id="portlet_tab_map_4_4_1" style="height:900px">
							            	</div>
							            	<div class="col-md-6" id="portlet_tab_bar_4_4_1" style="height:900px">
							            	</div>
						            	</div>
						            	<div class="row">
						            		<div class="col-sm-12">
...
<script>
	...
	require(
		...
		function(e){
			...
			$.ajax({
				...
				success: function(data){
				    ...
				    tooltip : {
				        ...
				        formatter : '{b}<br/>{a0}:{c0}%({c2}%)<br/>{a4}:{c4}%<br/>{a6}:{c6}%<br/>{a8}:{c8}%'
				    },
				    legend: {
				        y: 55,
			...
			$.ajax({
				...
				success: function(data){
					k.setOption({
						title : {text: '实时交件金额排名（万佣金）'},
						tooltip:{trigger:"axis"},
						legend:{data:["交件金额","交件金额（前次）"]},
						toolbox:{show:!0,
								 feature:{mark:{show:!1},
								 saveAsImage:{show:!0}}},
								 xAxis:[{
			...
			$.ajax({
				...
				success: function(data){
					j.setOption({
						title : {text: '实时交件数量排名（万佣金）'},
						tooltip:{trigger:"axis"},
						legend:{data:["申请单数","申请单数（前次）"]},
						toolbox:{show:!0,
								 feature:{mark:{show:!1},
								 saveAsImage:{show:!0}}},
								 xAxis:[{
	...
	return{init:function(){
		jQuery().dataTable&&(a(),b(),c(),d(),f(),g(),h(),i(),j(),k())}
	}}();
	...
	function toType(id)
	{
		var a=e.init(document.getElementById(id));
			$.ajax({
				url:"/applygather/getApplyGatherCountJSON",
				data:{
					startDay:'2015-12-01 00:00:00',
	...
	function toData()
	{
		...
		function(e){
			var n=e.init(document.getElementById("portlet_tab_bar_4_2_2"));
			$.ajax({
				url:"/applygather/getApplyGatherCountJSON",
				data:{
					startDay:'2015-12-01 00:00:00',
			...
			var f=e.init(document.getElementById("portlet_tab_map_4_4_1"));
			$.ajax({
				url:"/applygather/getApplyGatherCountJSON",
				data:{
					startDay:'2015-12-01 00:00:00',
			...
			//end map
			var g=e.init(document.getElementById("portlet_tab_bar_4_4_1"));
			$.ajax({
				url:"/applygather/getApplyGatherCountJSON",
				data:{
					startDay:'2015-12-01 00:00:00',
			...
			//end map bar
			var h=e.init(document.getElementById("portlet_tab_bar_4_3_1"));
			$.ajax({
				url:"/applygather/getApplyGatherCountJSON",
				data:{
					startDay:'2015-12-01 00:00:00',
