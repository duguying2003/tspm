...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
							...
							<li  class="active"><a href="event_analysis.html">页面内事件分析</a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">页面内事件分析</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">页面内事件分析 <small>时间段：[2015/1/1-2016/1/1] <a class="show-page-intro" href="javascript:;"><i class="fa fa-question-circle"></i></a></small></h1>
			<!-- end page-header -->

			<div class="panel panel-inverse" id="page-intro" style="display:none">
				<div class="panel-body">
					<div class="alert alert-info m-b-0">页面内事件分析<span class="close">×</span>
					</div>
			    </div>
			</div>
		...
		$(document).ready(function() {
		    ...
		    $(window).resize(function(){
		    	$(".echarts-box").each(function(){
		    		var _width = $(this).parent(".chart-container").width();
		    		var _height = $(this).parent(".chart-container").height();
		    		$(this).width(_width);
		    		$(this).height(_height);
		    	});
    ...
    <script src="color1.5/js/page/event_analysis.js"></script>
	...
	var getEventStatistic = function(startDay,endDay){
		$.ajax({
			url:"/event_analysis/getEventSequenceCount2",
			data:{
			startDay:startDay,
			endDay:endDay,
			pageId:pageId
	...
	var getAllData = function(){
		getEventStatistic(startDay,endDay);
	}
