	...
	require(
		...
		function(e){
			...
			t.setOption({
				...
				series:[{
					name:"High",type:"line",data:[11,11,15,13,12,13,10],
					markPoint:{data:[{type:"max",name:"Max"},{type:"min",name:"Min"}]},
					markLine:{data:[{type:"average",name:"Mean"}]}},
					{
					name:"Low",type:"line",data:[1,-2,2,5,3,2,0],
				...
				toolbox:{show:!0,
						 ...
						 dataRange:{
							 ...
							 series:[{
								 ...
								 data:function(){
									 for(var e,a=[],t=500;t--;)
										 e=(100*Math.random()).toFixed(2)-0,
									 a.push([(Math.random()*e+e).toFixed(2)-0,(Math.random()*e).toFixed(2)-0,e]);
									 return a}()
							 }]
			});
			...
			o.setOption({
				tooltip:{
					...
					formatter:function(e){
						var a=e[0].seriesName+" "+e[0].name;return a+="<br/>  Opening : "+e[0].value[0]+"  Highest : "+e[0].value[3],a+="<br/>  Closing : "+e[0].value[1]+"  Lowest : "+e[0].value[2]}
			},
			...
			xAxis:[{
				...
				data:["2013/1/24","2013/1/25","2013/1/28","2013/1/29","2013/1/30",
				      ...
				      "2013/3/7","2013/3/8","2013/3/11","2013/3/12",
				      "2013/3/13","2013/3/14","2013/3/15","2013/3/18",
				      "2013/3/19","2013/3/20","2013/3/21","2013/3/22",
				      "2013/3/25","2013/3/26","2013/3/27","2013/3/28",
				      "2013/3/29","2013/4/1","2013/4/2","2013/4/3",
				      "2013/4/8","2013/4/9","2013/4/10","2013/4/11",
				      "2013/4/12","2013/4/15","2013/4/16","2013/4/17",
				      "2013/4/18","2013/4/19","2013/4/22","2013/4/23",
				      "2013/4/24","2013/4/25","2013/4/26","2013/5/2",
				      "2013/5/3","2013/5/6","2013/5/7","2013/5/8",
